...
const firmTemplate = (data) => {
  let { name, email, phoneNumber, service } = data;
        ...
        <div class="email-wrapper">
          ...
          <div class="content">
            ...
            <table>
              ...
              <tr>
                <th>Service</th>
                <td class="message-cell">${service}</td>
              </tr>
            </table>
          </div>
          <div class="footer">
...
const handler = async (req, res) => {
  ...
  try {
    await dbConnection();
    let { name, phoneNumber, email, service } = req.body;
    let { error } = chatBotValidationSchema.validate({
      name,
      phoneNumber,
      email,
      service
    ...
    let isDataExist = await ChatBotModel.findOne({
      $or: [
        { email },
        {
          phoneNumber,
    ...
    let newContact = new ChatBotModel(req.body);
